...
// 
//   *exp_H = *exp_F1 - exp_G;
//    log_printf(NORMAL, "m2 %f %f %f", *exp_F1, *exp_F2, *exp_H);
...
//         _exp_table[full_index + 8] * dt2;
//    log_printf(NORMAL, "int %f %f %f", *exp_F1, *exp_F2, *exp_H);
//    //abort();
}
